...
def calc(filename, channel):
    if filename=='JetMETG':
        ...
        if channel == 'ee':
            output_hist_file = f"histos_JetMET_Run2022G_ee_testJul2024.root"
        elif channel == 'em':
            output_hist_file = f"histos_JetMET_Run2022G_em_testJul2024.root"
        else:
            output_hist_file = f"histos_JetMET_Run2022G_mm_testJul2024.root"
