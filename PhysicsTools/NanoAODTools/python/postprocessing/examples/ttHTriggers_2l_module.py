...
class TrigAnalysis(Module):
    ...
    def analyze(self, event):
        ...
        if (event.HLT_Ele32_WPTight_Gsf or event.HLT_IsoMu24 or event.HLT_Ele23_Ele12_CaloIdL_TrackIdL_IsoVL or event.HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_Mass3p8 or event.HLT_Mu23_TrkIsoVVL_Ele12_CaloIdL_TrackIdL_IsoVL or event.HLT_Mu8_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_DZ or event.HLT_Mu12_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_DZ):
